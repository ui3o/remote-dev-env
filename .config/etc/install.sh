...
# install nodejs
echo [$ARCH] install maven...
su - podman -c '/home/podman/.nix-profile/bin/nix-env -iA maven -f https://github.com/NixOS/nixpkgs/archive/8ad5e8132c5dcf977e308e7bf5517cc6cc0bf7d8.tar.gz'
echo [$ARCH] jdk17 nodejs...
su - podman -c '/home/podman/.nix-profile/bin/nix-env -iA jdk17 -f https://github.com/NixOS/nixpkgs/archive/8ad5e8132c5dcf977e308e7bf5517cc6cc0bf7d8.tar.gz'
