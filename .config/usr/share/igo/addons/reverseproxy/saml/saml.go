...
func InitSAML() {
	...
	SAMLSP, _ := samlsp.New(opt)
	SAMLSP.ServiceProvider.AuthnNameIDFormat = saml.NameIDFormat(SAMLConf.AuthnNameIDFormat)

	SAMLSP.Session = DefaultSessionProvider(opt, SAMLConf.Domain)
}
